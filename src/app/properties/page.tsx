    ...
    <DashboardShell>
      ...
      <ResourceManager
        ...
        fields={[
          ...
          { label: "پروژه", name: "projectId", optionEndpoint: "/api/projects", optionLabel: "name", placeholder: "از پروژه‌های ساخته‌شده انتخاب کنید", required: true, section: "اطلاعات اصلی", type: "select" },
